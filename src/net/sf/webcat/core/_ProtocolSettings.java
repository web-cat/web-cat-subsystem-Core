    ...
    implements net.sf.webcat.core.MutableContainer.MutableContainerOwner
{
    ...
    public static final ERXKey<net.sf.webcat.core.ProtocolSettings> parent =
        new ERXKey<net.sf.webcat.core.ProtocolSettings>(PARENT_KEY);
    // To-many relationships ---
    public static final String CHILDREN_KEY = "children";
    public static final ERXKey<net.sf.webcat.core.ProtocolSettings> children =
        new ERXKey<net.sf.webcat.core.ProtocolSettings>(CHILDREN_KEY);
     ...
     */
    public net.sf.webcat.core.ProtocolSettings parent()
    {
        return (net.sf.webcat.core.ProtocolSettings)storedValueForKey( "parent" );
    }
     ...
     */
    public void setParent( net.sf.webcat.core.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
            log.debug( "setParent("
        ...
        net.sf.webcat.core.ProtocolSettings value )
    {
        ...
        if ( value == null )
        {
            net.sf.webcat.core.ProtocolSettings object = parent();
            if ( object != null )
     ...
     */
    @SuppressWarnings("unchecked")
    public NSArray<net.sf.webcat.core.ProtocolSettings> children()
    {
     ...
     */
    public void setChildren( NSMutableArray<net.sf.webcat.core.ProtocolSettings>  value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToChildren( net.sf.webcat.core.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
        ...
        NSMutableArray<net.sf.webcat.core.ProtocolSettings> array =
            (NSMutableArray<net.sf.webcat.core.ProtocolSettings>)children();
        willChange();
     ...
     */
    public void removeFromChildren( net.sf.webcat.core.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToChildrenRelationship( net.sf.webcat.core.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromChildrenRelationship( net.sf.webcat.core.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
     ...
     */
    public net.sf.webcat.core.ProtocolSettings createChildrenRelationship()
    {
        if (log.isDebugEnabled())
        {
        ...
        addObjectToBothSidesOfRelationshipWithKey(
            eoObject, "children" );
        return (net.sf.webcat.core.ProtocolSettings)eoObject;
    }
     ...
     */
    public void deleteChildrenRelationship( net.sf.webcat.core.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
    ...
    public void deleteAllChildrenRelationships()
    {
        ...
        Enumeration<?> objects = children().objectEnumerator();
        while ( objects.hasMoreElements() )
            deleteChildrenRelationship(
                (net.sf.webcat.core.ProtocolSettings)objects.nextElement() );
    }
