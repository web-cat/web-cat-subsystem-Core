    ...
    extends org.webcat.core.EOBase
{
    ...
    {
        return (PasswordChangeRequest)ec.faultForGlobalID(id, ec);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public PasswordChangeRequest refetch(EOEditingContext editingContext)
    {
        return (PasswordChangeRequest)refetchObjectFromDBinEditingContext(
            editingContext);
    }
    ...
    {
        WCFetchSpecification<PasswordChangeRequest> fspec =
