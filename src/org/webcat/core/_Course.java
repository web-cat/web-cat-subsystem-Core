    ...
    extends org.webcat.core.EOBase
{
    ...
    {
        return (Course)ec.faultForGlobalID(id, ec);
    }
    ...
    // Attributes ---
    public static final String LMS_TITLE_KEY = "lmsTitle";
    public static final ERXKey<String> lmsTitle =
        new ERXKey<String>(LMS_TITLE_KEY);
     ...
     * @return An instance of this object in the target editing context
     */
    public Course refetch(EOEditingContext editingContext)
    {
        return (Course)refetchObjectFromDBinEditingContext(
            editingContext);
    }
    ...
    // ----------------------------------------------------------
    /**
     * Retrieve this object's <code>lmsTitle</code> value.
     * @return the value of the attribute
     */
    public String lmsTitle()
    {
        return (String)storedValueForKey( "lmsTitle" );
    }


    // ----------------------------------------------------------
    /**
     * Change the value of this object's <code>lmsTitle</code>
     * property.
     *
     * @param value The new value for this property
     */
    public void setLmsTitle( String value )
    {
        if (log.isDebugEnabled())
        {
            log.debug( "setLmsTitle("
                + value + "): was " + lmsTitle() );
        }
        takeStoredValueForKey( value, "lmsTitle" );
    }
