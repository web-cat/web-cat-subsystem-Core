/*==========================================================================*\
 ...
 |  DO NOT EDIT.  Make changes to LMSIdentity.java instead.
 |*-------------------------------------------------------------------------*|
 ...
 */
public abstract class _LMSIdentity
    extends org.webcat.core.EOBase
{
    ...
    // ----------------------------------------------------------
    /**
     * Creates a new _LMSIdentity object.
     */
    public _LMSIdentity()
    {
        super();
     ...
     * LMSIdentity object given required
     * attributes and relationships.
     * @param editingContext The context in which the new object will be
     * inserted
     * @param lmsUserIdValue
     * @param lmsInstanceValue
     * @param userValue
     * @return The newly created object
     */
    public static LMSIdentity create(
        EOEditingContext editingContext,
        String lmsUserIdValue,
        org.webcat.core.lti.LMSInstance lmsInstanceValue,
        org.webcat.core.User userValue
        )
    {
        LMSIdentity eoObject = (LMSIdentity)
            EOUtilities.createAndInsertInstance(
                editingContext,
                _LMSIdentity.ENTITY_NAME);
        eoObject.setLmsUserId(lmsUserIdValue);
     ...
     */
    public static LMSIdentity localInstance(
        EOEditingContext editingContext, LMSIdentity eo)
    {
        return (eo == null)
            ? null
            : (LMSIdentity)EOUtilities.localInstanceOfObject(
                editingContext, eo);
    }
    ...
    {
        return (LMSIdentity)ec.faultForGlobalID(id, ec);
    }
    ...
    // Attributes ---
    public static final String LMS_USER_ID_KEY = "lmsUserId";
    public static final ERXKey<String> lmsUserId =
        new ERXKey<String>(LMS_USER_ID_KEY);
    ...
    public static final String ENTITY_NAME = "LMSIdentity";
     ...
     */
    public LMSIdentity localInstance(EOEditingContext editingContext)
    {
        return (LMSIdentity)EOUtilities.localInstanceOfObject(
            editingContext, this);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public LMSIdentity refetch(EOEditingContext editingContext)
    {
        return (LMSIdentity)refetchObjectFromDBinEditingContext(
            editingContext);
    }
    ...
    // ----------------------------------------------------------
    /**
     * Retrieve this object's <code>lmsUserId</code> value.
     * @return the value of the attribute
     */
    public String lmsUserId()
    {
        return (String)storedValueForKey( "lmsUserId" );
    }


    // ----------------------------------------------------------
    /**
     * Change the value of this object's <code>lmsUserId</code>
     * property.
     *
     * @param value The new value for this property
     */
    public void setLmsUserId( String value )
    {
        if (log.isDebugEnabled())
        {
            log.debug( "setLmsUserId("
                + value + "): was " + lmsUserId() );
        }
        takeStoredValueForKey( value, "lmsUserId" );
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static NSArray<LMSIdentity> objectsWithFetchSpecification(
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LMSIdentity> allObjects(
        EOEditingContext context)
    {
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LMSIdentity> objectsMatchingQualifier(
        EOEditingContext context,
    ...
    {
        WCFetchSpecification<LMSIdentity> fspec =
     ...
     */
    public static LMSIdentity firstObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier,
        NSArray<EOSortOrdering> sortOrderings)
    {
     ...
     */
    public static LMSIdentity uniqueObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier) throws EOUtilities.MoreThanOneException
    {
        ...
        if (objects.size() > 1)
        {
            String msg = "fetching LMSIdentity";
            try
            {
                if (qualifier != null)
                {
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LMSIdentity> objectsMatchingValues(
        EOEditingContext context,
     ...
     * @return the first entity that was retrieved, or null if there was none
     */
    public static LMSIdentity firstObjectMatchingValues(
        EOEditingContext context,
        NSArray<EOSortOrdering> sortOrderings,
        Object... keysAndValues)
    {
     ...
     *     if there is more than one matching object
     */
    public static LMSIdentity uniqueObjectMatchingValues(
        EOEditingContext context,
        ...
        throws EOUtilities.MoreThanOneException
    {
        try
        {
            return (LMSIdentity)EOUtilities.objectMatchingValues(
    ...
    static Logger log = Logger.getLogger(LMSIdentity.class);
}
