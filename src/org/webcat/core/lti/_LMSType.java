/*==========================================================================*\
 ...
 |  DO NOT EDIT.  Make changes to LMSType.java instead.
 |*-------------------------------------------------------------------------*|
 ...
 */
public abstract class _LMSType
    extends org.webcat.core.EOBase
{
     ...
     */
    public static LMSType create(
        EOEditingContext editingContext,
        String nameValue
        )
    {
        LMSType eoObject = (LMSType)
            EOUtilities.createAndInsertInstance(
                editingContext,
                _LMSType.ENTITY_NAME);
     ...
     */
    public static LMSType localInstance(
        EOEditingContext editingContext, LMSType eo)
    {
        return (eo == null)
            ? null
            : (LMSType)EOUtilities.localInstanceOfObject(
                editingContext, eo);
    }
     ...
     */
    public static LMSType forId(
        EOEditingContext ec, int id)
    {
        LMSType obj = null;
        if (id > 0)
        {
            NSArray<LMSType> objects =
    ...
    {
        return (LMSType)ec.faultForGlobalID(id, ec);
    }
    ...
    public static final String ENTITY_NAME = "LMSType";
     ...
     */
    public LMSType localInstance(EOEditingContext editingContext)
    {
        return (LMSType)EOUtilities.localInstanceOfObject(
            editingContext, this);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public LMSType refetch(EOEditingContext editingContext)
    {
        return (LMSType)refetchObjectFromDBinEditingContext(
            editingContext);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static NSArray<LMSType> objectsWithFetchSpecification(
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LMSType> allObjects(
        EOEditingContext context)
    {
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LMSType> objectsMatchingQualifier(
        EOEditingContext context,
    ...
    {
        WCFetchSpecification<LMSType> fspec =
            new WCFetchSpecification<LMSType>(
     ...
     */
    public static LMSType firstObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier,
        NSArray<EOSortOrdering> sortOrderings)
    {
     ...
     */
    public static LMSType uniqueObjectMatchingQualifier(
        EOEditingContext context,
     ...
     * @return an NSArray of the entities retrieved
     */
    public static NSArray<LMSType> objectsMatchingValues(
        EOEditingContext context,
     ...
     * @return the first entity that was retrieved, or null if there was none
     */
    public static LMSType firstObjectMatchingValues(
        EOEditingContext context,
        NSArray<EOSortOrdering> sortOrderings,
        Object... keysAndValues)
    {
     ...
     *     if there is more than one matching object
     */
    public static LMSType uniqueObjectMatchingValues(
        EOEditingContext context,
        ...
        throws EOUtilities.MoreThanOneException
    {
        try
        {
            return (LMSType)EOUtilities.objectMatchingValues(
    ...
    static Logger log = Logger.getLogger(LMSType.class);
}
